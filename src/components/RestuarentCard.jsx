  ...
  return (
     <div className="p-1">
                  ...
                  >
                    ...
                    {/* Logo */}
                    <div className="absolute bottom-6 left-3 rounded-xl p-1 w-14 h-14 shadow-md z-20">
                      <img
                    ...
                    {/* Name */}
                    <div className="  text-white   absolute top-54 md:top-38 lg:top-42 left-20 z-20">
                      <h3 className="text-sm font-semibold w-34 break-words">
