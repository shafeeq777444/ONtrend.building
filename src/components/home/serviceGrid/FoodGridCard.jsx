    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between items-start z-10 relative">
                ...
                <div className="bg-white text-black cursor-pointer rounded-full p-2 opacity-0 group-hover:opacity-90 hover:rotate-45 duration-300 ease-in transition-all hover:bg-black hover:text-white">
