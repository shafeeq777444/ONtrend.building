...
import DiscountDealsCard from "../../components/food/DiscountDealsCard";
import { useGetNearestDiscountedVendors } from "../../hooks/queries/useVendors";
...
const FoodDiscountDeals = () => {
    ...
    const { data: discountedAllVendors } = useGetNearestDiscountedVendors(location?.lat, location?.lng);
    console.log(discountedAllVendors,"all vendor")
    const discountedFoodVendors = discountedAllVendors?.filter((d) => (d.vendorType = "Food/Restaurant"));
    console.log(discountedFoodVendors,"food vendors");
    return (
