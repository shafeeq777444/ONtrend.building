...
const CartPage = () => {
  ...
  const { mutate: removeFromCart } = useRemoveFromCart(userId);
                ...
                >
                  <div className="flex gap-4 items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-[#ff3131] mt-1">OMR {item.itemPrice}</p>
                    </div>
                  </div>
                  <div className="flex flex-col items-end gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        onClick={() => changeQuantity({ productId: item.id, delta: -1 })}
