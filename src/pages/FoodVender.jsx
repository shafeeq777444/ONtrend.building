        ...
        <div className="mt-14    min-h-screen bg-gradient-to-br" dir={isArabic ? "rtl" : "ltr"}>
            ...
            <div className="overflow-y-hidden bg-white rounded-t-2xl z-30 mt-70 scrollbar-hide ">
                <div ref={productsRef} className="bg-white backdrop-blur-sm  shadow-xl p-4">
                    {/* Categories */}
                    <FoodVendorMealCategory isLoading={vendorCategoryLoading} categories={vendorCategories} selectedCategory={selectedVendorMealCategory} />

                    {/* Products */}
                    <FoodVendorProducts isLoading={allProductsLoading} venderLogo={currentVendor?.image} foodItems={filteredFoods} isArabic={isArabic} />
