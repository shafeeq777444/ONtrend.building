...
export default function DeliveringTo({ place = "New York", onClick }) {
  return (
    <button
      onClick={onClick}
      className="inline-flex items-center gap-2 px-3 h-10 py-2 bg-white/10 backdrop-blur-sm rounded-md border border-white/20 hover:bg-white/20 transition-all duration-200 cursor-pointer group"
    >
